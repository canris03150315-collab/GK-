...
interface SettingsProps {
    ...
    onUpdateInfo: (info: PaymentInfo) => void;
}
...
const PaymentSettings: React.FC<SettingsProps> = ({ currentInfo, onUpdateInfo }) => {
                ...
                <div>
                 ...
                 <div>
                    ...
                    <div className="flex items-center justify-center w-full mt-1">
                        <label htmlFor="payment-image-upload" className="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                            {previewUrl ? (
                            ...
                            <input id="payment-image-upload" type="file" className="hidden" accept="image/*" onChange={handleImageChange} />
                        </label>
                    </div>
                </div>
                <button
